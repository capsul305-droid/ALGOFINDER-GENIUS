...
# PERBAIKAN: Menggunakan layout="wide" yang benar
st.set_page_config(page_title="ALGOFINDER GENIUS PRO", layout="wide")

# CSS untuk membuat tampilan tabel lebih padat dan ringkas
st.markdown("""
    <style>
    .stApp { background-color: #ffffff; color: #000000; }
    div[data-testid="stDataFrame"] { padding: 0 !important; }
    table { border-collapse: collapse !important; font-family: monospace !important; }
    td { width: 25px !important; height: 25px !important; padding: 2px !important; text-align: center !important; font-size: 11px !important; }
